...
Write-Host "===== Get-MappedDrives v1 ====="
...
$rows | Sort-Object Drive | Export-Csv -Path $Out -NoTypeInformation -Encoding UTF8
...
if ($EmitMapping) {
    ...
    [System.IO.File]::WriteAllLines($mapFile, $lines, $utf8Bom)
    Write-Host ""
